...
def title(subject):
    ...
    exceptions = ['a', 'an', 'the', 'v', 'vs', 'am', 'at', 'and', 'as', 'but', 'by', 'en', 'for', 'if', 'be', 'in',
                  'of', 'on', 'or', 'to', 'via', ]
...
class WikiLinkPlusExtension(markdown.Extension):
    ...
    def __init__(self, configs={}):
        self.config = {
            'base_url': ['/searchName?q=', 'String to append to beginning or URL.'],
            'end_url': ['', 'String to append to end of URL.'],
            'url_whitespace': ['_', 'String to replace white space in the URL'],
